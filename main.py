...
class MentalMathsApp(MDApp):
    def __init__(self, **kwargs):
        ...
        self.challenges = {
            "Multiply By 11": {
                "Timed Quiz": Medals(Challenge(f"Get {TimedQuiz.target} correct answers in 30 seconds", lambda score: score <= 30),
                                     Challenge(f"Get {TimedQuiz.target} correct answers in  10 seconds", lambda score: score <= 10),
                                     Challenge(f"Get {TimedQuiz.target} correct answers in 5 seconds", lambda score: score <= 5)),
